    ...
    <div class="container">
        ...
        <div class="market-container">
            <div class="new-product">
                <h2>Takeaway Products</h2>
                <router-link to="/admin/takeaway/new-product"><i class="fa-solid fa-plus"></i> New Product </router-link>
            </div>
            <div class="products">
                <table>
                    <thead>
                        ...
                        <th style="width: 30%;">Name & Detail</th>
                    ...
                    <tr v-for="item in products" :key="item.id">
                        ...
                        <td>{{ item.category }}</td>
                        <td>{{ item.name }} <br> {{ item.detail }}</td>
                        <td>€{{ item.price }}</td>
                        <td>%{{ item.discountRate }}</td>
                        <td>
                            <router-link to="/admin/takeaway/edit-product">
...
export default {
    ...
    methods: {
        getImageUrl(image) {
            return new URL(`../../assets/restaurant-page/${image}`,
